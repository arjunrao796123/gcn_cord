...
#folderName_json = r"/home/arjun/test_gcn/json/test/test_img_1/"
#folderName_image = r'/home/arjun/Graph-Convolution-on-Structured-Documents/data/test/exp_1_1_img/'
#folderNameReceipt_csv = '/home/arjun/test_gcn/test/test_img_1/'
dataframe_collection = {}
Image_count = 0
...
def train(epoch):
    ...
    loss_avg_val = []
    for i in range(rage):
        # print(i,'batchhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh')
        first_features = 0
        for j in range(i * batch_size, (i + 1) * batch_size):
            if first_features == 0:
                labels_test_batch = dataframe_collection['Image_' + str(r[j])].iloc[:, 13:]
        ...
        # print(features_sp_batch.shape,'features_sp_batch')
        ...
        output,embeddings = model(features_sp_merged_sparse, sp_adj)
        # print(labels)
        # print(idx_batch_train)
        ...
        loss_val = F.nll_loss(output[idx_batch_val], labels[idx_batch_val])
        loss_avg_val.append(loss_val)

        acc_val = accuracy(output[idx_batch_val], labels[idx_batch_val])
        acc_avg_val.append(acc_val.item())
        # print(str(i),'batchhh'),
